...
# anticheat-arm64-%{version}/ (repo name, not package name) regardless of
# the tarball's own filename; %%autosetup below relies on that.
...
%prep
%autosetup -n anticheat-arm64-%{version}
